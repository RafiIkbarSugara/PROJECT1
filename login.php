  ...
  <div class="anim-fade-in w-full max-w-sm">
    <div class="bg-white rounded-3xl shadow-xl border border-neutral-200/60 overflow-hidden">
      ...
      <div class="flex bg-neutral-100 m-4 rounded-xl p-1 gap-1">
        ...
        <button type="button" id="tabUser" class="tab-active flex-1 py-2.5 rounded-lg text-sm font-bold transition-all flex items-center justify-center gap-2">
          <iconify-icon icon="solar:user-bold" width="18"></iconify-icon> Pelanggan
        </button>
      </div>
      ...
      <form id="loginForm" onsubmit="handleLogin(event)" class="px-6 pb-6 space-y-4">
        ...
        <p class="text-sm text-neutral-500">Belum punya akun pelanggan? <a href="register.php" class="font-bold text-emerald-600 hover:underline">Daftar di sini</a></p>
      </div>
    </div>
